	...
	sock.ev.on("messages.upsert", async ({ messages, type }) => {
        ...
        if(type === "notify"){
            if(!messages[0].key.fromMe) {
                ...
                }else if(!messages[0].key.fromMe && pesanMasuk === "fido"){
                    await sock.sendMessage(noWa, {text: "Ini fido, saya hanyalah bot"},{quoted: messages[0] });
                }else if(!messages[0].key.fromMe && pesanMasuk === "elvira"){
                    await sock.sendMessage(noWa, {text: "halo, elvira disini ada elvira jangan lari"},{quoted: messages[0] });
                }else if(!messages[0].key.fromMe && pesanMasuk === "elvira"){
                    await sock.sendMessage(noWa, {text: "halo, elvira disini ada elvira jangan lari"},{quoted: messages[0] });
                }
                    //  else{
